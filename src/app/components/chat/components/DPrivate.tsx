...
import { getDeliveryBoyChatFunction, getOneChatFunction } from '../../../services/Chat/Chat'
import io from 'socket.io-client';
import clsx from 'clsx'
import { ChatInner } from '../../../../_metronic/partials/chat/DChatInner';


const DPrivateChat: FC = () => {
  // use State
  ...
  const getCustomerChat = async () => {
    const res = await getDeliveryBoyChatFunction()
    console.log("driver",res?.data?.data);
  ...
  const connectSocket = async (chats:any) => {
    ...
    socket.on('message_received_driver',(newmessage: any) => {
      if (newmessage) {
    ...
    socket.on('new_chat_driver', (newchat: any) => {
      console.log(newchat);
                    ...
                    >
                      ...
                      {!isEmpty ? (
                        ...
                        <div className='text-center'>
                          <img src="../../../../../public/media/illustrations/sketchy-1/17.png" width={"277px"} alt="" />
