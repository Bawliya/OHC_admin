...
import { getOneChatFunction, getpartnerChatFunction } from '../../../services/Chat/Chat'
import io from 'socket.io-client';
import clsx from 'clsx'
import { ChatInner } from '../../../../_metronic/partials/chat/PChatInner';


const PPrivateChat: FC = () => {
  // use State
  ...
  const getCustomerChat = async () => {
    const res = await getpartnerChatFunction()
  ...
  const connectSocket = async (chats:any) => {
    ...
    socket.on('message_received_partner',(newmessage: any) => {
      if (newmessage) {
    ...
    socket.on('new_chat_partner', (newchat: any) => {
      console.log(newchat);
