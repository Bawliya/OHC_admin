...
import { getFunction, getOrderListFunction } from '../../../services/order/order';
...
const DeliveryTransactionsTableComponent: React.FC<types> = ({ id }) => {
    ...
    const getRestaurant = async (currentPage: any, limit: any, searchValue: any) => {
        const resp: any = await getFunction(currentPage, limit, searchValue, DeliveryId); // Pass currentPage to API call
