      ...
      <div className='card mb-5 mb-xl-10' id='kt_profile_details_view'>
        <div className='card-header cursor-pointer'>
          <div className='card-title m-0'>
            <h3 className='fw-bolder m-0'>Delivery Boy Details</h3>
          </div>
  ...
  <div className='row mb-7'>
    <div className='col-lg-6'>
      <div className='row mb-7'>
        ...
        <div className='col-lg-6'>
          <span className='fw-bolder fs-6 text-gray-900'>{data.name}</span>
        </div>
      </div>
      ...
      <div className='row mb-7'>
        <label className='col-lg-6 fw-bold text-muted'>DOB</label>
        <div className='col-lg-6'>
          <span className='fw-bolder fs-6 text-gray-900'>{data.dob}</span>
        </div>
      </div>

      <div className='row mb-7'>
        <label className='col-lg-6 fw-bold text-muted'>Id Type</label>
        <div className='col-lg-6'>
          <span className='fw-bolder fs-6 text-gray-900'>{data.id_type}</span>
        </div>
      </div>
