...
import { AddTERMFunction, getWebFunction } from "../services/setting/setting";
...
const TermsConditionsDetailsCard: React.FC = () => {
  ...
  const getRestaurantList = async () => {
    ...
    console.log(res.data?.data?.customer_termandcondition);
    setNewValue(res.data?.data?.customer_termandcondition);
  };
  ...
  async function addPrivacy(e: any) {
    ...
    if (!newValue || newValue.trim() === "") {
      notifyError("Terms and Conditions  is required.");
      setLoading(false);
      return;
    }
    const obj = {
      customer_termandcondition: newValue,
    };
    const response = await AddTERMFunction(obj);
...
export default TermsConditionsDetailsCard;
