...
const BranchTablePage: React.FC<props> = ({setActiveTab}) => {
  ...
  useEffect(() => {
    getRestaurant(currentPage, 10, search, restaurantID);
  ...
  const getRestaurant = async (
    ...
    const resp: any = await getBranchViewFunction(
      currentPage,
      limit,
      search,
      restaurantID
