...
import {getOrderListFunctionUser } from '../../../services/order/order';
...
const DeliveryOrderComponent: React.FC<types> = ({id}) => {
    ...
    const getRestaurant = async (currentPage: any, limit: any, searchValue: any) => {
        const resp: any = await getOrderListFunctionUser(currentPage, limit, searchValue,DeliveryId); // Pass currentPage to API call
