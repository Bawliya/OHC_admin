...
import { ProfileHeader } from "./profile/BranchHeader";

const ViewBranchComponent: React.FC = () => {
      ...
      <div className="row">
        ...
        <div className="">
          <div className="app-container container-fluid">
            <img
              src="/media/logos/applogo.png"
              className="h-60px w-155px"
              alt=""
            />
          </div>
        </div>
