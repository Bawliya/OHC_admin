...
import {
  getBrowseFunction,
  deleteBrowseFunction,
  EditBrowseFunction,
} from "../../../services/browse/Browse";
import { BackgroundBeams } from "../../../UI/background-beams";
import Swal from "sweetalert2";
import TableBrowseComponent from "../../../components/BrowseTableComponent";
import { KTIcon } from "../../../../_metronic/helpers";

const BrowseTablePage: React.FC = () => {
  ...
  const getBanners = async (currentPage: any, limit: any, searchValue: any) => {
    setLoading(true);
    const resp: any = await getBrowseFunction(currentPage, limit, searchValue); // Pass currentPage to API call
    console.log(resp);
...
export default BrowseTablePage;
