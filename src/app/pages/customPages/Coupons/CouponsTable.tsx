...
import TableCouponsComponent from "../../../components/CouponsTableComponent";
import { EditCouponsFunction, getCouponsFunction } from "../../../services/Coupons/coupons";
import { KTIcon } from '../../../../_metronic/helpers';

const CouponsTablePage: React.FC = () => {
  ...
  const getBanners = async (currentPage: any, limit: any,searchValue:any) => {
    const resp: any = await getCouponsFunction(currentPage, limit,searchValue); // Pass currentPage to API call
  ...
  const handleUpdate = async (formData: any) => {
    const response = await EditCouponsFunction(formData);
