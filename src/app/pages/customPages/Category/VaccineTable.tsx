...
import VaccineTables from "../../../components/VaccineTable";
import {
  getCategoryFunction,
...
import { getVaccineFunction } from "../../../services/Vaccine/VaccinServices";
...
const VaccineTable: React.FC = () => {
  ...
  const getBanners = async (currentPage: any, limit: any, searchValue: any) => {
    const resp: any = await getVaccineFunction(currentPage, limit, searchValue); // Pass currentPage to API call
