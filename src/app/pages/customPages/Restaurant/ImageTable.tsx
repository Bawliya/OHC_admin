...
import { getImageFunction } from "../../../services/Restaurant/Restaurant";

const ImageTablePage: React.FC = () => {
  ...
  const getBanners = async (currentPage: any, limit: any) => {
    const resp: any = await getImageFunction(currentPage, limit); // Pass currentPage to API call
    // console.log("resp------------------", resp);
    if (resp?.data.status) {
      setTableData(resp?.data?.videos);
