...
import DeliveryBoyTableComponent from '../../../components/DeliveryBoyTable';
import AccountHeader from '../../../components/accounts/AccountHeader';
import { getDeliveryBoyFunction } from '../../../services/deliveryboy/DeliveryBoy';
import { KTIcon } from '../../../../_metronic/helpers';

const ViewDeliveryBoyPage: React.FC = () => {
  ...
  const getRestaurant = async (currentPage: any, limit: any, search: any) => {
    const resp: any = await getDeliveryBoyFunction(currentPage, limit, search); // Pass currentPage to API call
...
export default ViewDeliveryBoyPage;
